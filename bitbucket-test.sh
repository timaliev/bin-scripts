#!/bin/bash
exec scala -savecompiled -classpath "lib/lift-json_2.11-3.0-SNAPSHOT.jar:play-ws_2.11-2.3.8.jar:play_2.11-2.3.8.jar" "$0" "$0" "$@"
!#
...
object PrintBibucketIssues {
  	...
  	def main(args: Array[String]) {
	    ...
	    val testJson = pretty(render(parse(fileContent) \ "local_id" ))
	    println(s"\n ${testJson}\n")
